    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Sensors",
                columns: new[] { "Id", "NameSensor", "Type", "Unit", "Value" },
                values: new object[] { 2, "Vazão", "Vazão", "L", "1.05" });

            migrationBuilder.InsertData(
                table: "Datas",
                columns: new[] { "Id", "ClientId", "MessageId", "Payload", "QoS", "RetainFlag", "SensorId", "TimeStamp", "Topic" },
                values: new object[] { 1, "clientId seed 1", 1, "payload seed 1", "qos seed 1", true, 1, new DateTime(2022, 3, 31, 15, 18, 32, 73, DateTimeKind.Local).AddTicks(3927), "topic seed 1" });

            migrationBuilder.InsertData(
                table: "Datas",
                columns: new[] { "Id", "ClientId", "MessageId", "Payload", "QoS", "RetainFlag", "SensorId", "TimeStamp", "Topic" },
                values: new object[] { 2, "clientId seed 2", 2, "payload seed 2", "qos seed 2", true, 1, new DateTime(2022, 3, 31, 15, 18, 32, 73, DateTimeKind.Local).AddTicks(3938), "topic seed 2" });
