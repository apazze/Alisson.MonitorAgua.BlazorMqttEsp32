    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 4, 14, 10, 35, 31, 291, DateTimeKind.Local).AddTicks(529), "150" },
                    { 2, new DateTime(2022, 4, 14, 10, 35, 31, 291, DateTimeKind.Local).AddTicks(877), "170" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "clientId seed 1", 1, "payload seed 1", "qos seed 1", true, 1, new DateTime(2022, 4, 14, 10, 35, 31, 289, DateTimeKind.Local).AddTicks(3785), "topic seed 1" });

            migrationBuilder.InsertData(
                table: "Datas",
                columns: new[] { "Id", "ClientId", "MessageId", "Payload", "QoS", "RetainFlag", "SensorId", "TimeStamp", "Topic" },
                values: new object[] { 2, "clientId seed 2", 2, "payload seed 2", "qos seed 2", true, 1, new DateTime(2022, 4, 14, 10, 35, 31, 290, DateTimeKind.Local).AddTicks(7466), "topic seed 2" });
